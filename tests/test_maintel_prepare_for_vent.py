...
class TestPrepareForVent(
    ...
    async def test_vent_while_sun_sets_progresses_through_sun_elevation_bands(self):
        async with self.make_dry_script():
            ...
            # once more to follow the dome after the sun drops below
            # SUN_ELEVATION_HORIZON. Dome azimuths are wrapped to the
            # mount's [-260, 260] deg travel range before being sent to the
