...
class TestOffsetDome(
    ...
    async def test_run(self):
        async with self.make_dry_script():
            self.script.mtcs.check_dome_following = unittest.mock.AsyncMock(
                side_effect=[False]
            )
    ...
    async def test_run_while_dome_following(self):
        expected_error = (
        ...
        async with self.make_dry_script():
            ...
            self.script.mtcs.assert_all_enabled.assert_not_awaited()
