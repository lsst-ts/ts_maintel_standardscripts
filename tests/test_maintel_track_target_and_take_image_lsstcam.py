...
class TestMainTelTrackTargetAndTakeImageLSSTCam(
    standardscripts.BaseScriptTestCase, unittest.IsolatedAsyncioTestCase
):
    """Test Main Telescope track target and take image with LSSTCam script.
    ...
    def setUpClass(cls) -> None:
        cls.log = logging.getLogger("TestMainTelTrackTargetAndTakeImageLSSTCam")
    ...
    async def basic_make_script(self, index):
        self.script = TrackTargetAndTakeImageLSSTCam(index=index, add_remotes=False)
    ...
    async def test_run_with_filter_change(self):
        async with self.make_script(), self.setup_mocks():
            ...
            self.script.lsstcam.setup_filter.assert_awaited_once_with(
