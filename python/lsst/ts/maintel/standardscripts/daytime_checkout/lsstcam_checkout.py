...
class LsstCamCheckout(salobj.BaseScript):
    ...
    **Details**
    ...
    Dark frames provide a finite integration while avoiding the daytime
    dome-light risk of open-shutter engineering frames, and still exercise
    image acquisition and OODS ingestion, including WFS coverage.
    """
