...
class BaseTelescopeCheckout(salobj.BaseScript):
    ...
    both the TMA and MTDome. Dome shutters are required to remain closed and
    are never commanded.
    ...
    async def run(self) -> None:
        ...
        self.log.info(
            ...
            f"rot={self.mtcs.tel_park_rot + self.delta_rot}); "
        ...
        await self.checkpoint("Slew to checkout target and start tracking.")
