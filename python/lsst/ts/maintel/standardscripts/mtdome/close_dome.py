...
class CloseDome(salobj.BaseScript):
    ...
    **Checkpoints**
    ...
    Closing dome: Before commanding dome shutter to be closed.
    """

    def __init__(self, index):
        super().__init__(index=index, descr="Close MTDome shutter.")
    ...
    async def run(self):
        ...
        await self.checkpoint("Closing dome")
        await self.mtcs.close_dome(force=self.config.force)
